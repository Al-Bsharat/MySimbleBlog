...
from django.urls import reverse_lazy  # Or from django.core.urlresolvers import reverse_lazy
from blog.forms import PostForm, CommentForm
from blog.models import Post, Comment
from django.views.generic import (TemplateView, ListView, DetailView, CreateView, UpdateView, DeleteView)

# This is for CBV but for function based view we was used: from django.contrib.auth.decorators import login_required
